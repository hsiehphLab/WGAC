...
snakemake -s trf.snake populate_trf_with_links -j 100 
...
snakemake -s trf.snake --jobname "{rulename}.{jobid}" --profile profile  -j 500 -k --rerun-incomplete --restart-times 1
