...
# added Jan 10, 2024  Note that the module load should set PERL5LIB as hard-coded below.
# However, when it is run under make, it doesn't.  I can't explain it, but that is the way it is.  (DG)
...
export PERL5LIB=${PERL5LIB}:/projects/standard/hsiehph/shared/software/perl/perl_modules/Tk/lib/perl5
